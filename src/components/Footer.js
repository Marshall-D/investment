...
function Footer() {
  return (
    <div style={{marginTop:"1px"}}>
      ...
      <div className="bg-primary" style={{marginTop:"17px",height:"6px"}}></div>
      <div className="bg-primary" style={{marginTop:"18px",height:"5px"}}></div>
      <div className="bg-primary" style={{marginTop:"19px",height:"4px"}}></div>
      <div className="bg-primary" style={{marginTop:"20px",height:"3px"}}></div>
      <div className="bg-primary" style={{marginTop:"21px",height:"2px"}}></div>
      <div className="bg-primary" style={{marginTop:"22px",height:"1px"}}></div>
      <div className="bg-primary" style={{marginTop:"23px",height:"0px"}}></div>
